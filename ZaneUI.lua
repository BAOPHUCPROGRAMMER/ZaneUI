...
function create:Win()
    ...
    UIGradient_PageTap.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(102, 255, 178)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(102, 255, 178))}
...
function tap:addtap(text)
    ...
    TextLabel_Tap.Text = " "
    TextLabel_Tap.TextColor3 = Color3.fromRGB(102, 255, 178)
...
function page:addpage()
    ...
    Page.BackgroundColor3 = Color3.fromRGB(102, 255, 178)
...
function ems:Button(text,callback)
    ...
    TextLabel_emsTextButton.BackgroundColor3 = Color3.fromRGB(102, 255, 178)
    ...
    TextLabel_emsTextButton.TextColor3 = Color3.fromRGB(102, 255, 178)
    ...
    MheeFrameStroke.Color = Color3.fromRGB(102, 255, 178)
    ...
    --    if joincheck.check1 == false then
            ...
            TweenService:Create(
                ...
                {BackgroundColor3 =  Color3.fromRGB(102, 255, 178)} -- UDim2.new(0, 128, 0, 25)
            ):Play()
--     end
...
function ems:Button1(text,callback)
    ...
    ToggleFrame1.BackgroundColor3 = Color3.fromRGB(102, 255, 178)
    ...
    MheeFrameStroke1.Color = Color3.fromRGB(102, 255, 178)
...
function  ems:Toggle(text,de,callback)
    ...
    ToggleButton2.BackgroundColor3 = Color3.fromRGB(102, 255, 178)
    ...
    TextLabelToggle.BackgroundColor3 = Color3.fromRGB(102, 255, 178)
    ...
    TextButton_2_Toggle.BackgroundColor3 = Color3.fromRGB(102, 255, 178)
    TextButton_2_Toggle.BorderColor3 = Color3.fromRGB(102, 255, 178)
    ...
    TextButton_3_Toggle.BorderColor3 = Color3.fromRGB(102, 255, 178)
...
function ems:DropDown(text,text2,list,callback)
    ...
    DropFrame.BackgroundColor3 = Color3.fromRGB(102, 255, 178)
    ...
    TextLabelDrop.BackgroundColor3 = Color3.fromRGB(102, 255, 178)
    ...
    FrameDrop.BackgroundColor3 = Color3.fromRGB(102, 255, 178)
    ...
    DropButton.BackgroundColor3 = Color3.fromRGB(102, 255, 178)
    ...
    TextLabelDrop2.BackgroundColor3 = Color3.fromRGB(102, 255, 178)
    ...
    TextButton_Dropdown.BackgroundColor3 = Color3.fromRGB(102, 255, 178)
    ...
    ListFrame.BackgroundColor3 = Color3.fromRGB(102, 255, 178)
    ...
    listDropButton.TextColor3 = Color3.fromRGB(102, 255, 178)
...
function ems:Slder(text,min,max,de,callback)
    ...
    TalabelSlider.BackgroundColor3 = Color3.fromRGB(102, 255, 178)
    ...
    MainValue.BackgroundColor3 = Color3.fromRGB(102, 255, 178)
...
function ems:Ti(text)
    ...
    lineframe.BackgroundColor3 = Color3.fromRGB(102, 255, 178)
    ...
    lineframe2.BackgroundColor3 = Color3.fromRGB(102, 255, 178)
    ...
    lineframe3.TextColor3 = Color3.fromRGB(102, 255, 178)
